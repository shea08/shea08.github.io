...
I started using excel as a method for calculating my grades in high school and college. My favorite thing to do is take a syllabus and determine what grade I need in a class in order to get the grade I desire. Equation can be very powerful. My favorite tool is the "countif" equation and the conditional formatting function. The most useful tool I have created is a running calendar using an equation to auto-populate the day of the week until infinity. I then insert shapes to create events.
...
this.page.url = "https://shea08.github.io/microsoft";  // Replace PAGE_URL with your page's canonical URL variable
this.page.identifier = "/microsoft/"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};
*/
